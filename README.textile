...
* *Inline Image Generation Languages*
** *GNUPLOT*: http://www.gnuplot.info/
** *Pic*: http://en.wikipedia.org/wiki/Pic_language
** *GraphViz*: http://http://www.graphviz.org/
...
<pre>scarlet slideshow.textile # Generates slideshow/index.html</pre>
...
* Right/Enter/Space Bar/Page Down - Forward slide
* Left/Page Up - Backward slide
* # g - Jump to slide # (EG: 5g - jump to slide 5)
* Esc - Go to the first slide

h2. Contributors

* *Kurt Stephens*: Inline image generation, navigation enhancements, slide numbers, bug fixes.
